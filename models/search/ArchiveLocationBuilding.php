 ...
 *
 * ArchiveLocationBuilding represents the model behind the search form about `ommu\archiveLocation\models\ArchiveLocationBuilding`.
 *
...
namespace ommu\archiveLocation\models\search;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use ommu\archiveLocation\models\ArchiveLocationBuilding as ArchiveLocationBuildingModel;

class ArchiveLocationBuilding extends ArchiveLocationBuildingModel
{
	/**
	 * {@inheritdoc}
	 */
