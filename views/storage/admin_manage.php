 ...
 * @var $searchModel ommu\archiveLocation\models\search\ArchiveLocationStorage
 *
...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Add Storage'), 'url' => Url::to(['create']), 'icon' => 'plus-square', 'htmlOptions' => ['class' => 'btn btn-success modal-btn']],
];
